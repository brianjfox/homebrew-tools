class Gnash < Formula
  ...
  bottle do
    root_url "https://github.com/brianjfox/homebrew-tools/releases/download/gnash-1.3.4"
    sha256 cellar: :any_skip_relocation, arm64_tahoe: "5c8e6b60e8a37c412429bd45013380183305a53ed760b9abc4d656626228f1e9"
  end
